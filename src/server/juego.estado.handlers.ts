// Logica de /api/juego/estado, portada de src/pages/api/juego/estado.ts (Astro).
...
export async function estadoJuego(): Promise<Response> {
  try {
...
export async function actualizarConfigJuego(request: Request): Promise<Response> {
  try {
