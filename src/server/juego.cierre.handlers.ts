// Logica de /api/juego/cierre, portada de src/pages/api/juego/cierre.ts (Astro).
// Orquesta el cierre nocturno completo: habitos + dano HP + dia perfecto + nudge de
// ayuno + fresh start de lunes.
...
import type { Dificultad } from '../lib/habitos/scoring.ts';
...
// start de lunes).
export async function cierreJuego(): Promise<Response> {
  try {
