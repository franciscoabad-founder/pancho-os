// Logica de /api/habitos/brief, portada de src/pages/api/habitos/brief.ts (Astro).
// Solo lectura: arma el daily brief que consume Cortex/Hermes para Telegram.
...
import { evaluarEtapa, type Criterio } from '../lib/habitos/journeys.ts';
...
// de Telegram). Solo lectura, sin escrituras.
...
export async function brief(): Promise<Response> {
  try {
