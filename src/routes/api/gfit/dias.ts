// Server route de dias de rutina de GFIT, portado de src/pages/api/gfit/dias.ts
// (Astro) a TanStack Start. Mismo molde que rutinas.ts: logica inline, mismo
// contrato HTTP. gfit_dia_hoy (src/mcp/osTools.ts) depende de GET
// /api/gfit/dias?rutina_id=... para resolver el dia de hoy.
...
export const Route = createFileRoute('/api/gfit/dias')({
  server: {
    handlers: {
      GET: async ({ request }) => {
